...
#Install Marzban
sudo bash -c "$(curl -sL https://raw.githubusercontent.com/hendramla/asu/main/marzban.sh)" @ install

#Install Subs
wget -N -P /var/lib/marzban/templates/subscription/  https://raw.githubusercontent.com/hendramla/asu/main/index.html

#install env
wget -O /opt/marzban/.env "https://raw.githubusercontent.com/hendramla/asu/main/env"

#install core Xray & Assets folder
mkdir -p /var/lib/marzban/assets
mkdir -p /var/lib/marzban/core
wget -O /var/lib/marzban/core/xray.zip "https://github.com/XTLS/Xray-core/releases/download/v25.1.1/Xray-linux-64.zip"  
cd /var/lib/marzban/core && unzip xray.zip && chmod +x xray
cd

#profile
echo -e 'profile' >> /root/.profile
wget -O /usr/bin/profile "https://raw.githubusercontent.com/hendramla/asu/main/profile";
chmod +x /usr/bin/profile
apt install neofetch -y
wget -O /usr/bin/cekservice "https://raw.githubusercontent.com/hendramla/asu/main/cekservice.sh"
chmod +x /usr/bin/cekservice

#install compose
wget -O /opt/marzban/docker-compose.yml "https://raw.githubusercontent.com/hendramla/asu/main/docker-compose.yml"
...
wget -O /opt/marzban/nginx.conf "https://raw.githubusercontent.com/hendramla/asu/main/nginx.conf"
wget -O /opt/marzban/default.conf "https://raw.githubusercontent.com/hendramla/asu/main/vps.conf"
wget -O /opt/marzban/xray.conf "https://raw.githubusercontent.com/hendramla/asu/main/xray.conf"
mkdir -p /var/www/html
echo "<pre>HENDRA GANTENK 696969</pre>" > /var/www/html/index.html
...
#install database
wget -O /var/lib/marzban/db.sqlite3 "https://github.com/hendramla/asu/raw/main/db.sqlite3"
...
echo "-=================================-" | tee -a log-install.txt
echo "Telegram Group: https://t.me/hendramla" | tee -a log-install.txt
echo "-=================================-" | tee -a log-install.txt
